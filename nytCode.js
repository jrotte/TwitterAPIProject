...
var authKey = "G3XvBQLmdYx3CCRPOwMTydLQm";
...
var queryURLBase = "https://api.twitter.com/1.1/search/tweets.json?api-key=" +
  authKey + "&q=";
...
jQuery.ajaxPrefilter(function(options) {
  ...
  $.ajax({
    url: queryURL,
    method: "GET",
    beforeSend: function(xhr){xhr.setRequestHeader('origin', 'localhost');},
